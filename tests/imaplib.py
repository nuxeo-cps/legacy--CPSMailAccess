...
class fake_socket:
    ...
    def makefile(self, mode='r', bufsize=-1):
        return fake_socketfile(self, mode, bufsize)
...
class IMAP4:
    ...
    def __init__(self, host = '', port = IMAP4_PORT):
        ...
        self.welcome = 'welcome to fake server'
    ...
    def open(self, host = '', port = IMAP4_PORT):
        ...
        self.host = host
        self.port = port
        self.sock = fake_socket(socket.AF_INET, socket.SOCK_STREAM)

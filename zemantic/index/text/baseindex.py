...
from zemantic.index.interfaces import IInjection, IStatistics, IExtendedQuerying
from zemantic.index.text import widcode
from zemantic.index.text.setops import mass_weightedIntersection, \
                                  mass_weightedUnion
...
class BaseIndex(Persistent):
    ...
    def index_doc(self, docid, text):
        if len(self._docwords) > 0:
            #if docid in self._docwords:
            if docid in list(self._docwords.keys()):

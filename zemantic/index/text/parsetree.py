...
from zemantic.index.interfaces.queryparsetree import IQueryParseTree
from zemantic.index.text.setops import mass_weightedIntersection, mass_weightedUnion

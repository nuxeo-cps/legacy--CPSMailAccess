...
from Products.CPSMailAccess.zemantic.rdflib.constants import STATEMENT, SUBJECT, PREDICATE, OBJECT
from Products.CPSMailAccess.zemantic.rdflib.constants import RDFS_DOMAIN, RDFS_SUBCLASSOF

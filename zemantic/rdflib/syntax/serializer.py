from Products.CPSMailAccess.zemantic.rdflib.exceptions import \
    SerializerDispatchNameError, SerializerDispatchNameClashError
import Products.CPSMailAccess.zemantic.rdflib.syntax.serializers
...
class SerializationDispatcher(object):
    ...
    def __init__(self, store):
        self.store = store
        for ser in Products.CPSMailAccess.zemantic.rdflib.syntax.serializers.__all__:

from Products.CPSMailAccess.zemantic.rdflib.exceptions import \
    ParserDispatchNameError, ParserDispatchNameClashError
import Products.CPSMailAccess.zemantic.rdflib.syntax.parsers
...
class ParserDispatcher(object):
    ...
    def __init__(self, store):
        self.store = store
        for ser in Products.CPSMailAccess.zemantic.rdflib.syntax.parsers.__all__:

...
from Products.CPSMailAccess.zemantic.rdflib.Store import Store
from Products.CPSMailAccess.zemantic.rdflib.Store import \
    check_subject, check_predicate, check_object


from Products.CPSMailAccess.zemantic.rdflib.exceptions import ContextTypeError
...
from Products.CPSMailAccess.zemantic.rdflib.constants import TYPE
...
class InformationStore(Store):
    def __init__(self, path=None, backend=None):
        if backend==None:
            from Products.CPSMailAccess.zemantic.rdflib.backends.SleepyCatBackend \
                import SleepyCatBackend
